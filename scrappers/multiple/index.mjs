...
import { scrape_carnival } from "./carnival/index.mjs";
import { scrape_royal } from "./royal-caribbean/index.mjs";
import { scrape_celebrity } from "./celebrity-cruises/index.mjs";
import { scrape_princess } from "./princess-cruises/index.mjs";
import { scrape_cunard } from "./cunard/index.mjs";
import { scrape_seabourn } from "./seabourn/index.mjs";
import { scrape_hollandamerica } from "./hollandamerica/index.mjs";
...
const files = [
    ...
    "./carnival/data.json",
    "./royal-caribbean/data.json",
    "./celebrity-cruises/data.json",
    "./princess-cruises/data.json",
    "./cunard/data.json",
    "./seabourn/data.json",
    "./hollandamerica/data.json",
];
...
async function runAllScrapers() {
    ...
    // // phase 2
    // console.log("started: scrape_carnival")
    // await scrape_carnival()
    // console.log("end: scrape_carnival")

    // console.log("started: scrape_royal")
    // await scrape_royal()
    // console.log("end: scrape_royal")

    // console.log("started: scrape_celebrity")
    // await scrape_celebrity()
    // console.log("end: scrape_celebrity")

    // console.log("started: scrape_princess")
    // await scrape_princess()
    // console.log("end: scrape_princess")

    // console.log("started: scrape_cunard")
    // await scrape_cunard()
    // console.log("end: scrape_cunard")

    // console.log("started: scrape_seabourn")
    // await scrape_seabourn()
    // console.log("end: scrape_seabourn")

    // console.log("started: scrape_hollandamerica")
    // await scrape_hollandamerica()
    // console.log("end: scrape_hollandamerica")
